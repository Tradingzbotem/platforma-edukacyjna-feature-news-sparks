      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 h-12 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <nav className="hidden md:flex items-center gap-4 text-sm text-white/80">
            <Link href="/konto" className="hover:text-white">Dashboard</Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/konto" className="inline-flex items-center gap-2 rounded-md bg-white/10 border border-white/15 px-3 py-1.5 text-sm hover:bg-white/15">
