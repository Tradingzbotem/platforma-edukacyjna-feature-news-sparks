  ...
  return (
    <section className="mb-14">
      ...
      <header className="mx-auto max-w-4xl text-center space-y-3">
        <h1 className="text-balance text-3xl md:text-4xl font-extrabold tracking-tight text-white">
          Challenge: Przewidywalność
        </h1>
        <p className="mx-auto mt-3 max-w-3xl text-pretty text-sm md:text-base leading-relaxed text-white/70">
          Każdego dnia możesz sprawdzić swoją intuicję rynkową.
          Wybierz instrument, przejrzyj skrót z modułu <span className="font-semibold text-white">News</span>,
          oceń kierunek (<span className="font-semibold text-emerald-400">↑</span> /
      ...
      <div className="mx-auto mt-10 max-w-5xl rounded-2xl border border-white/10 bg-white/5 p-6">
        <h2 className="mb-4 text-center text-sm font-semibold uppercase tracking-wide text-white">
          Na jakiej podstawie prognozujesz wzrost lub spadek?
        </h2>
        <ul className="mx-auto grid max-w-4xl gap-2 text-sm leading-relaxed text-white/70 md:grid-cols-2">
          <li>
        ...
        <p className="mx-auto mt-4 max-w-3xl text-center text-xs leading-5 text-white/60">
