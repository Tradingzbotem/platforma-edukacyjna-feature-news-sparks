...
export default function TopCard({ article }: TopCardProps) {
	...
	return (
		...
		>
			<div className={`relative ${REDAKCJA_GRID_CARD_THUMB_H} w-full overflow-hidden`}>
			...
			<div className="flex flex-col gap-2 p-3">
				...
				{article.excerpt ? (
					<p className="text-xs leading-relaxed text-zinc-400 line-clamp-2">{article.excerpt}</p>
				) : null}
