        ...
        >
          ...
          <div className="relative z-10 flex flex-1 flex-col px-7 pb-8 pt-8 sm:px-8 sm:pb-9 sm:pt-9">
            ...
            <div className="mt-auto pt-16 sm:pt-20">
              ...
              <p className="mt-3 text-[11px] font-medium uppercase tracking-[0.18em] text-emerald-200/55">{passLabel}</p>
              <p className="mt-6 text-sm leading-relaxed text-white/45">{accessLine}</p>
              <p className="mt-8 text-lg font-medium tabular-nums tracking-wide text-white/[0.88] sm:text-xl">{price}</p>
              {priceNextLine ? (
                <p className="mt-1.5 text-xs text-white/45">{priceNextLine}</p>
              ) : null}
            </div>
          </div>
        </div>
...
export default async function HomePage() {
  ...
  const steps = [
    { step: '1', title: t('step1_title'), body: t('step1_body') },
    { step: '2', title: t('step2_title'), body: t('step2_body') },
    { step: '3', title: t('step3_title'), body: t('step3_body') },
  ];
  const platformCards = [
    { Icon: Radar, title: t('pf_0_title'), desc: t('pf_0_desc') },
    { Icon: Layers, title: t('pf_1_title'), desc: t('pf_1_desc') },
  ...
  const nftCardLabels: HeroNftLabels = {
    ...
    edition: t('hero_nft_edition'),
    passLabel: t('hero_nft_pass'),
    accessLine: t('hero_nft_access'),
  ...
  return (
    <main id="content" className="min-h-screen bg-slate-950 text-white">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 lg:py-20">
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-12 xl:gap-14">
            <div className="min-w-0 lg:col-span-7">
              <div className="max-w-3xl">
                <div className="inline-flex items-center gap-2 rounded-full border border-emerald-400/30 bg-emerald-500/10 px-4 py-1.5 text-xs font-medium text-emerald-200/90 mb-6">
                  ...
                  <span className="tracking-wide font-semibold">{t('hero_kicker')}</span>
                </div>
            ...
            <div className="flex justify-center lg:col-span-5 lg:justify-end lg:pl-2">
              <HeroFoundersNftCard {...nftCardLabels} />
            </div>
          </div>
        </div>
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 lg:py-16">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">{t('benefits_title')}</h2>
          <p className="mt-2 text-white/65 max-w-2xl text-sm sm:text-base">{t('benefits_sub')}</p>
      ...
      <section className="border-t border-white/10 bg-white/[0.02]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 lg:py-16">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">{t('how_title')}</h2>
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 lg:py-16">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">{t('platform_title')}</h2>
          <p className="mt-2 text-white/65 max-w-2xl text-sm sm:text-base">{t('platform_sub')}</p>
          <div className="mt-10 grid gap-4 sm:grid-cols-2 items-stretch">
            {platformCards.map(({ Icon, title, desc }) => (
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 lg:py-16">
          <div className={`${cardBase} p-8 sm:p-10 border-emerald-400/20`}>
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">{t('founders_title')}</h2>
            <p className="mt-3 text-white/75 max-w-2xl text-sm sm:text-base leading-relaxed">
              <span className="text-white/90">
                {t('founders_price_line', {
                  current: FOUNDERS_MARKET_PRICING.currentPriceUsd,
                  next: FOUNDERS_MARKET_PRICING.nextPriceUsd,
                })}
              </span>{' '}
              {t('founders_body')}
            </p>
            ...
            <div className="mt-10 rounded-xl border border-white/[0.08] bg-white/[0.02] p-4 sm:p-5">
              <p className="text-xs text-white/45 font-medium">{t('legal_label')}</p>
          ...
          <div className="animate-fade-in">
            <div className={homeMarketCard}>
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-white">{t('market_title')}</h2>
                <p className="mt-3 sm:mt-4 text-white/75 max-w-3xl text-sm sm:text-base leading-relaxed">{t('market_body')}</p>
              </div>
            </div>
          </div>
        </div>
